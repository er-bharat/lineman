...
static CommentRule rules[] = {
	...
	{ "md",     NULL, "<!--", "-->" }, /* Markdown comments */
	{ "rst",    "..", NULL, NULL },    /* reStructuredText */
	
	/* ============================================================
	 * Functional & niche (but popular)
	 * ============================================================ */
	{ "hs",     "--", "{-", "-}" },    /* Haskell */
	{ "lhs",    "--", "{-", "-}" },
	
	{ "ml",     "(*", "(*", "*)" },    /* OCaml (approximation) */
	{ "mli",    "(*", "(*", "*)" },
	
	{ "clj",    ";",  NULL, NULL },    /* Clojure */
	{ "cljs",   ";",  NULL, NULL },
	
	{ "el",     ";",  NULL, NULL },    /* Emacs Lisp */
	{ "lisp",   ";",  NULL, NULL },
	 ...
	 * Data / misc
	 * ============================================================ */
	{ "json",   NULL, NULL, NULL },    /* officially no comments */
	{ "jsonc",  "//", "/*", "*/" },    /* VSCode-style JSON */
